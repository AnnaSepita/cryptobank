...
import {RequestService} from "../../../../cryptobank/src/app/shared/services/request.service";
//import {HttpClient} from "@angular/common/http";

/**
 * Generated class for the AddwalletsComponent component.
 *
...
@Component({
  selector: 'addwallets',
  templateUrl: 'addwallets.html'
})
export class AddwalletsComponent {
